...
import { Snowflake, ShoppingBag, Wrench, User, LogOut, ShoppingCart, LayoutDashboard } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-dark">FrostFlow</span>
          </Link>
